    ...
    <table align="center" border="1" width="60%">
    	...
    	<tr>
    		<td colspan="11" align="center">
    			<a href="servlet/ShowAllServlet?index=1&size=${pageBean.size }&size=${pageBean.size }">首页</a>
    			<c:if test="${pageBean.index!=1 }">
    				<a href="servlet/ShowAllServlet?index=${pageBean.index-1 }&size=${pageBean.size }">上一页</a>
    			</c:if>
    			<c:if test="${pageBean.index==1 }">
    				<a href="servlet/ShowAllServlet?index=${pageBean.totalPageCount }&size=${pageBean.size }">上一页</a>
    			</c:if>
    			...
    			<c:if test="${pageBean.index==pageBean.totalPageCount }">
    				<a href="servlet/ShowAllServlet?index=1&size=${pageBean.size }">下一页</a>
    			</c:if>
